...
![Вкладка "Шаблоны"](<../../.gitbook/assets/image (3041).png>)
...
![Конструктор. Вкладка Шаблоны](<../../.gitbook/assets/image (3697).png>)
...
![Компонент "Текст"/"Мультитекст". Ограничить шрифты](<../../.gitbook/assets/image (2717).png>)
{% endtab %}
...
![Компонент "Текст на корешке". Ограничить шрифты](<../../.gitbook/assets/image (2717).png>)
{% endtab %}
{% endtabs %}
