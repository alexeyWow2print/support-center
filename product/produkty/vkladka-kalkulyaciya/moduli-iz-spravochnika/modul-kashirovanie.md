...
* Для добавления каширования нажмите кнопку **«Добавить»**. Выберите существующую операцию из списка или создайте новую. (см. статью [Каширование](../../../../handbook/dop.-operacii/kashirovanie.md)).
...
* **Настройка** — переход к детальной настройке параметров выбранной операции. (см. статью [Каширование](../../../../handbook/dop.-operacii/kashirovanie.md)
