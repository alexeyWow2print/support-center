...
* **X\_API\_DOMAIN**: Укажите домен API. Данные предоставляет ваш интегратор Axiom.
...
{% hint style="warning" %}
* Удалить модули, созданные в Axiom, через TCS **нельзя**.
* **Нельзя редактировать** параметры, влияющие на расчет цены и сроков производства. Эти данные управляются исключительно через справочники в системе Axiom.
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/image (3998).png" alt=""><figcaption></figcaption></figure>
...
{% hint style="warning" %}
Модуль «Цветность» передается в TCS по-разному, в зависимости от версии продукта Axiom. В **версии 1** для этого необходимо вручную установить тип цветности «Произвольная». В **версии 2** модуль появляется автоматически.<br>
...
1. Убедитесь, что у вас заранее создан нужный [конструкторский размер](../../../konstruktor/konstruktory/standart-poligrafiya.md) в TCS.
...
{% tabs %}
{% tab title="В настройках Калькуляции" %}
